...
const form = useForm({
  ...
  plesk_credentials: [{ username: '', password: '' }],
  website_credentials: [{ username: '', password: '' }],
  portal_credentials: [{ url: '', username: '', password: '' }],
  notes: '',
});
...
<template>
  <Head title="Add domain credentials" />

  <AuthenticatedLayout>
    <template #header>Add domain credentials</template>

    <div class="admin-form-page">
      <div class="admin-form-page-top">
        <div class="admin-form-page-header">
          <h1 class="admin-form-page-title">Add domain credentials</h1>
          <p class="admin-form-page-desc text-muted small">
            Enter credentials for a domain. Add multiple emails, Plesk users, website logins, and portal entries. Passwords are encrypted.
          </p>
        </div>
        <div class="admin-form-page-top-actions">
          ...
          <PrimaryButton type="submit" form="create-credential-form" :disabled="form.processing" class="btn btn-primary btn-sm admin-btn-smooth">Save</PrimaryButton>
        </div>
      </div>

      <form id="create-credential-form" class="admin-box admin-box-smooth" @submit.prevent="form.post(route('credentials.store'))">
          ...
          <div class="credential-section-body">
            ...
            <div v-for="(item, i) in form.email_credentials" :key="'em-' + i" class="credential-row">
              <div class="row g-2 align-items-center">
                <div class="col-md-5">
                  <TextInput
                    v-model="form.email_credentials[i].username"
                    class="form-control form-control-sm"
                ...
                <div class="col-md-5">
                  <TextInput
                    v-model="form.email_credentials[i].password"
                    type="password"
                    class="form-control form-control-sm"
                    placeholder="••••••••"
                ...
                <div class="col-md-2 credential-row-actions">
                  <button v-if="i === form.email_credentials.length - 1" type="button" class="btn btn-outline-primary btn-sm credential-add-btn me-1" title="Add another" @click="addEmail">+ Add</button>
                  <button type="button" class="btn btn-outline-danger btn-sm credential-remove-btn" title="Remove" :disabled="form.email_credentials.length <= 1" @click="removeEmail(i)">− Remove</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="credential-section-body">
            ...
            <div v-for="(item, i) in form.plesk_credentials" :key="'pl-' + i" class="credential-row">
              <div class="row g-2 align-items-center">
                ...
                <div class="col-md-5">
                  <TextInput v-model="form.plesk_credentials[i].password" type="password" class="form-control form-control-sm" placeholder="••••••••" autocomplete="new-password" />
                </div>
                <div class="col-md-2 credential-row-actions">
          ...
          <div class="credential-section-body">
            ...
            <div v-for="(item, i) in form.website_credentials" :key="'web-' + i" class="credential-row">
              <div class="row g-2 align-items-center">
                ...
                <div class="col-md-5">
                  <TextInput v-model="form.website_credentials[i].password" type="password" class="form-control form-control-sm" placeholder="••••••••" autocomplete="new-password" />
                </div>
                <div class="col-md-2 credential-row-actions">
          ...
          <div class="credential-section-body">
            ...
            <div v-for="(item, i) in form.portal_credentials" :key="'por-' + i" class="credential-row">
              <div class="row g-2 align-items-center">
                ...
                <div class="col-md-5">
                  <TextInput v-model="form.portal_credentials[i].password" type="password" class="form-control form-control-sm" placeholder="••••••••" autocomplete="new-password" />
                </div>
                <div class="col-md-2 credential-row-actions">
        ...
        <div class="credential-section">
          ...
          <textarea
            ...
            class="form-control form-control-sm"
            rows="3"
            placeholder="Extra notes about this domain"
          />
        ...
        <div class="d-flex gap-2 mt-3">
          <Link :href="route('credentials.index')" class="btn btn-secondary btn-sm admin-btn-smooth">Cancel</Link>
          <PrimaryButton type="submit" :disabled="form.processing" class="btn btn-primary btn-sm admin-btn-smooth">Save credentials</PrimaryButton>
        </div>
      </form>
    </div>
  </AuthenticatedLayout>
